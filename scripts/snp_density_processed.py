...
This script is identical to snp_density.py except it uses find_snp_positions_processed instead of
    find_snp_positions.
...
def main():
    ...
    snp_positions = find_snp_positions_processed(core_genome_alignment)[0]
